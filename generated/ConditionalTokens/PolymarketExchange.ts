...
export class PolymarketExchange__getOrderStatusResultValue0Struct extends ethereum.Tuple {
...
export class PolymarketExchange__hashOrderInputOrderStruct extends ethereum.Tuple {
  get salt(): BigInt {
...
export class PolymarketExchange__orderStatusResult {
  value0: boolean;
  value1: BigInt;
...
export class PolymarketExchange__registryResult {
  value0: BigInt;
  value1: Bytes;
...
export class PolymarketExchange extends ethereum.SmartContract {
  static bind(address: Address): PolymarketExchange {
    return new PolymarketExchange("PolymarketExchange", address);
  }
  ...
  getOrderStatus(
    orderHash: Bytes,
  ): PolymarketExchange__getOrderStatusResultValue0Struct {
    let result = super.call(
      "getOrderStatus",
    ...
    return changetype<PolymarketExchange__getOrderStatusResultValue0Struct>(
      result[0].toTuple(),
    );
  }
  ...
  try_getOrderStatus(
    orderHash: Bytes,
  ): ethereum.CallResult<PolymarketExchange__getOrderStatusResultValue0Struct> {
    let result = super.tryCall(
      "getOrderStatus",
      "getOrderStatus(bytes32):((bool,uint256))",
      [ethereum.Value.fromFixedBytes(orderHash)],
    ...
    return ethereum.CallResult.fromValue(
      changetype<PolymarketExchange__getOrderStatusResultValue0Struct>(
        value[0].toTuple(),
      ),
    );
  }
  ...
  hashOrder(order: PolymarketExchange__hashOrderInputOrderStruct): Bytes {
    let result = super.call(
      "hashOrder",
  ...
  try_hashOrder(
    order: PolymarketExchange__hashOrderInputOrderStruct,
  ...
  orderStatus(param0: Bytes): PolymarketExchange__orderStatusResult {
    let result = super.call(
      "orderStatus",
    ...
    return new PolymarketExchange__orderStatusResult(
      result[0].toBoolean(),
      result[1].toBigInt(),
    );
  }
  ...
  try_orderStatus(
    param0: Bytes,
  ): ethereum.CallResult<PolymarketExchange__orderStatusResult> {
    let result = super.tryCall(
      "orderStatus",
      "orderStatus(bytes32):(bool,uint256)",
      [ethereum.Value.fromFixedBytes(param0)],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new PolymarketExchange__orderStatusResult(
        value[0].toBoolean(),
        value[1].toBigInt(),
      ),
    );
  ...
  registry(param0: BigInt): PolymarketExchange__registryResult {
    let result = super.call("registry", "registry(uint256):(uint256,bytes32)", [
      ethereum.Value.fromUnsignedBigInt(param0),
    ]);

    return new PolymarketExchange__registryResult(
      result[0].toBigInt(),
      result[1].toBytes(),
    );
  }
  ...
  try_registry(
    param0: BigInt,
  ): ethereum.CallResult<PolymarketExchange__registryResult> {
    let result = super.tryCall(
      "registry",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new PolymarketExchange__registryResult(
        value[0].toBigInt(),
        value[1].toBytes(),
      ),
    );
